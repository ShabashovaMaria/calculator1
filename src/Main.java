...
//получается в строке 5 значение 0, на ноль делить нельзя, стоит в условиях
        // можно поменять входящие данные
    }
}
...
//        для математических операций над двумя числами. Типизируйте их как Integer:
//
//        BinaryOperator<Integer> plus = (x, y) -> x + y;
//        BinaryOperator<Integer> minus = (x, y) -> x - y;
//        BinaryOperator<Integer> multiply = (x, y) -> x * y;
//        BinaryOperator<Integer> devide = (x, y) -> x / y;
//        Добавьте несколько переменных типа UnaryOperator для
//        произведения математических операций над одним числом:
//
...
//        Реализация
//        В классе Main в методе main() создайте экземпляр класса
//        Calculator через вызов статической переменной instance:
//
//        Calculator calc = Calculator.instance.get();
